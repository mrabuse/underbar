(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var wrongAnswers = [];
    var falseTest = function(item) {
    	return !test(item);
    }

    wrongAnswers = _.filter(collection, falseTest);
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(isTrue, result) {
      return Boolean(isTrue && iterator(result));
    }, true);
  };
